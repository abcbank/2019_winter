...
reg   [67:0] indvar_flatten1_reg_102;
reg   [31:0] i_reg_113;
reg   [35:0] indvar_flatten_reg_122;
reg   [3:0] j_reg_133;
reg   [31:0] k_reg_144;
wire   [0:0] tmp_11_fu_163_p1;
reg   [0:0] tmp_11_reg_399;
wire   [9:0] tmp_3_fu_185_p2;
reg   [9:0] tmp_3_reg_404;
wire  signed [3:0] f_cast_fu_191_p1;
reg  signed [3:0] f_cast_reg_409;
...
wire   [67:0] bound6_fu_231_p2;
reg   [67:0] bound6_reg_431;
...
wire   [67:0] indvar_flatten_next1_fu_248_p2;
...
wire   [3:0] tmp_3_mid2_fu_323_p3;
reg   [3:0] tmp_3_mid2_reg_459;
reg   [15:0] ifmap_read_reg_466;
reg   [15:0] ap_reg_pp0_iter1_ifmap_read_reg_466;
wire   [8:0] tmp_14_fu_331_p1;
reg   [8:0] tmp_14_reg_472;
wire   [31:0] k_2_fu_335_p2;
wire   [35:0] indvar_flatten_next_fu_347_p3;
wire   [8:0] tmp_6_fu_383_p2;
reg   [8:0] tmp_6_reg_487;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg    ap_enable_reg_pp0_iter1;
reg    ap_enable_reg_pp0_iter2;
reg   [31:0] ap_phi_mux_i_phi_fu_116_p4;
reg   [3:0] ap_phi_mux_j_phi_fu_137_p4;
wire   [63:0] tmp_17_cast_fu_389_p1;
wire   [8:0] tmp_fu_157_p2;
wire   [0:0] tmp_2_fu_167_p2;
wire   [8:0] smax3_fu_173_p3;
wire   [9:0] smax3_cast_fu_181_p1;
wire   [9:0] c_cast1_cast_fu_153_p1;
wire   [4:0] f_cast2_cast1_fu_199_p1;
wire   [4:0] tmp_s_fu_210_p2;
wire  signed [31:0] tmp_14_cast_fu_224_p1;
wire   [31:0] bound6_fu_231_p1;
wire   [5:0] f_cast2_cast_fu_203_p1;
wire   [5:0] tmp_11_cast_fu_220_p1;
wire   [0:0] exitcond_flatten_fu_260_p2;
wire   [31:0] i_1_fu_254_p2;
wire   [0:0] tmp_12_fu_289_p1;
wire   [0:0] exitcond_fu_298_p2;
wire   [3:0] j_mid_fu_266_p3;
wire   [0:0] exitcond1_mid1_fu_303_p3;
wire   [31:0] k_mid_fu_274_p3;
wire   [3:0] j_2_fu_310_p2;
wire   [31:0] k_mid2_fu_316_p3;
wire   [35:0] indvar_flatten_op_fu_341_p2;
wire   [7:0] tmp_13_fu_358_p3;
wire   [8:0] p_shl1_cast_fu_365_p1;
wire   [8:0] tmp_3_mid2_cast_fu_355_p1;
wire   [8:0] tmp_15_fu_375_p1;
wire   [8:0] tmp_5_fu_369_p2;
wire   [8:0] tmp_16_fu_378_p2;
wire    ap_CS_fsm_state6;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [67:0] bound6_fu_231_p10;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        f_cast2_reg_414[3 : 0] <= f_cast2_fu_195_p1[3 : 0];
        f_cast_reg_409 <= f_cast_fu_191_p1;
        tmp_1_reg_426[4 : 0] <= tmp_1_fu_216_p1[4 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten1_fu_243_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_14_reg_472 <= tmp_14_fu_331_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_11_reg_399 <= tmp_11_fu_163_p1;
...
assign bound6_fu_231_p2 = (68'd225 * bound6_fu_231_p1);

assign c_cast1_cast_fu_153_p1 = c;
...
assign exitcond_flatten_fu_260_p2 = ((indvar_flatten_reg_122 == 36'd225) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next1_fu_248_p2 = (indvar_flatten1_reg_102 + 68'd1);

assign indvar_flatten_next_fu_347_p3 = ((exitcond_flatten_fu_260_p2[0:0] === 1'b1) ? 36'd1 : indvar_flatten_op_fu_341_p2);

assign indvar_flatten_op_fu_341_p2 = (indvar_flatten_reg_122 + 36'd1);

assign j_2_fu_310_p2 = (4'd1 + j_mid_fu_266_p3);

assign j_mid_fu_266_p3 = ((exitcond_flatten_fu_260_p2[0:0] === 1'b1) ? 4'd0 : ap_phi_mux_j_phi_fu_137_p4);
...
assign p_shl1_cast_fu_365_p1 = tmp_13_fu_358_p3;

assign smax3_cast_fu_181_p1 = smax3_fu_173_p3;

assign smax3_fu_173_p3 = ((tmp_2_fu_167_p2[0:0] === 1'b1) ? c : tmp_fu_157_p2);

assign tmp_11_cast_fu_220_p1 = tmp_s_fu_210_p2;

assign tmp_11_fu_163_p1 = c[0:0];

assign tmp_12_fu_289_p1 = tmp_17_t_mid2_v_v_fu_281_p3[0:0];

assign tmp_13_fu_358_p3 = {{tmp_3_mid2_reg_459}, {4'd0}};

assign tmp_14_cast_fu_224_p1 = $signed(tmp_3_reg_404);

assign tmp_14_fu_331_p1 = k_mid2_fu_316_p3[8:0];

assign tmp_15_fu_375_p1 = $unsigned(f_cast_reg_409);

assign tmp_16_fu_378_p2 = (tmp_14_reg_472 - tmp_15_fu_375_p1);

assign tmp_17_cast_fu_389_p1 = tmp_6_reg_487;

assign tmp_17_t_mid2_fu_293_p2 = (tmp_12_fu_289_p1 ^ tmp_11_reg_399);
...
assign tmp_2_fu_167_p2 = ((c > tmp_fu_157_p2) ? 1'b1 : 1'b0);

assign tmp_3_fu_185_p2 = (smax3_cast_fu_181_p1 - c_cast1_cast_fu_153_p1);
...
assign tmp_6_fu_383_p2 = (tmp_5_fu_369_p2 + tmp_16_fu_378_p2);

assign tmp_fu_157_p2 = (9'd2 + c);

assign tmp_s_fu_210_p2 = (5'd15 + f_cast2_cast1_fu_199_p1);

always @ (posedge ap_clk) begin
    f_cast2_reg_414[31:4] <= 28'b0000000000000000000000000000;
    tmp_1_reg_426[31:5] <= 27'b000000000000000000000000000;
end
