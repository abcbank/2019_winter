...
reg   [35:0] indvar_flatten_reg_229;
reg   [3:0] j_reg_240;
reg   [31:0] k_reg_251;
wire  signed [3:0] f_cast2_fu_260_p1;
reg  signed [3:0] f_cast2_reg_425;
wire   [4:0] tmp_1_fu_272_p2;
reg   [4:0] tmp_1_reg_431;
wire   [5:0] tmp_5_fu_296_p2;
reg   [5:0] tmp_5_reg_436;
...
wire   [35:0] bound_fu_319_p2;
reg   [35:0] bound_reg_457;
...
wire   [35:0] indvar_flatten_next_fu_330_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [3:0] tmp_7_mid2_v_fu_354_p3;
reg   [3:0] tmp_7_mid2_v_reg_471;
(* use_dsp48 = "no" *) wire   [8:0] tmp_10_fu_369_p2;
reg   [8:0] tmp_10_reg_477;
wire   [31:0] k_1_fu_375_p2;
reg   [7:0] O_BRAM_0_addr_reg_487;
reg   [7:0] O_BRAM_1_addr_reg_493;
reg   [7:0] O_BRAM_2_addr_reg_499;
reg   [7:0] O_BRAM_3_addr_reg_505;
reg   [7:0] O_BRAM_4_addr_reg_511;
reg   [7:0] O_BRAM_5_addr_reg_517;
reg   [7:0] O_BRAM_6_addr_reg_523;
reg   [7:0] O_BRAM_7_addr_reg_529;
...
wire   [4:0] f_cast1_cast1_fu_264_p1;
wire   [0:0] tmp_4_fu_278_p2;
wire   [4:0] smax1_fu_284_p3;
wire   [5:0] smax1_cast_fu_292_p1;
wire   [5:0] f_cast1_cast_fu_268_p1;
wire  signed [31:0] tmp_5_cast_fu_312_p1;
wire   [31:0] bound_fu_319_p1;
wire   [0:0] tmp_s_fu_342_p2;
wire   [3:0] j_1_fu_336_p2;
wire   [31:0] k_mid2_fu_347_p3;
wire   [8:0] tmp_8_fu_362_p1;
wire   [8:0] tmp_9_fu_366_p1;
wire   [8:0] grp_fu_417_p3;
...
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [35:0] bound_fu_319_p10;
wire   [8:0] grp_fu_417_p10;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        f_cast1_reg_441[3 : 0] <= f_cast1_fu_302_p1[3 : 0];
        tmp_1_cast_reg_447[4 : 0] <= tmp_1_cast_fu_305_p1[4 : 0];
...
assign bound_fu_319_p2 = (36'd13 * bound_fu_319_p1);
...
assign grp_fu_417_p0 = 9'd13;

assign grp_fu_417_p1 = grp_fu_417_p10;

assign grp_fu_417_p10 = tmp_7_mid2_v_reg_471;

assign indvar_flatten_next_fu_330_p2 = (indvar_flatten_reg_229 + 36'd1);

assign j_1_fu_336_p2 = (4'd1 + ap_phi_mux_j_phi_fu_244_p4);
...
assign tmp_1_fu_272_p2 = (5'd13 + f_cast1_cast1_fu_264_p1);
...
assign tmp_8_fu_362_p1 = k_mid2_fu_347_p3[8:0];
...
always @ (posedge ap_clk) begin
    f_cast1_reg_441[31:4] <= 28'b0000000000000000000000000000;
    tmp_1_cast_reg_447[31:5] <= 27'b000000000000000000000000000;
end
