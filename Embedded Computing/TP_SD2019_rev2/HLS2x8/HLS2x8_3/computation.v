...
wire   [63:0] tmp_32_cast_fu_865_p1;
wire   [63:0] tmp_33_cast_fu_892_p1;
...
HLS2x8_3_mul_mul_bkb #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS2x8_3_mul_mul_bkb_U25(
    .din0(W_BRAM_0_1_q0),
...
HLS2x8_3_mul_mul_bkb #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS2x8_3_mul_mul_bkb_U32(
    .din0(W_BRAM_7_1_q0),
    .din1(I_BRAM_1_load_reg_1174),
    .dout(tmp_52_7_1_fu_986_p2)
);

HLS2x8_3_mac_mulacud #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 4 ),
    .din1_WIDTH( 5 ),
...
always @ (posedge ap_clk) begin
    if (((ap_reg_pp0_iter4_exitcond_flatten4_reg_1048 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        O_BRAM_0_addr_reg_1306 <= tmp_33_cast_fu_892_p1;
        O_BRAM_1_addr_reg_1312 <= tmp_33_cast_fu_892_p1;
        O_BRAM_2_addr_reg_1318 <= tmp_33_cast_fu_892_p1;
        O_BRAM_3_addr_reg_1324 <= tmp_33_cast_fu_892_p1;
        O_BRAM_4_addr_reg_1330 <= tmp_33_cast_fu_892_p1;
        O_BRAM_5_addr_reg_1336 <= tmp_33_cast_fu_892_p1;
        O_BRAM_6_addr_reg_1342 <= tmp_33_cast_fu_892_p1;
        O_BRAM_7_addr_reg_1348 <= tmp_33_cast_fu_892_p1;
    end
end
...
assign p_shl2_cast_fu_840_p1 = tmp_25_fu_833_p3;
...
assign tf_mid2_fu_791_p3 = ((tmp_24_fu_786_p2[0:0] === 1'b1) ? 4'd0 : tf_reg_510);
...
assign tmp_24_fu_786_p2 = (tmp_14_fu_781_p2 | exitcond_flatten_reg_1057);

assign tmp_25_fu_833_p3 = {{tmp_5_mid2_reg_1123}, {4'd0}};

assign tmp_32_cast_fu_865_p1 = tmp_17_fu_859_p2;

assign tmp_33_cast_fu_892_p1 = grp_fu_991_p3;
