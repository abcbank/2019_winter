...
HLS2x8_5_mul_mul_bkb #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS2x8_5_mul_mul_bkb_U25(
    .din0(W_BRAM_0_1_q0),
...
HLS2x8_5_mul_mul_bkb #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS2x8_5_mul_mul_bkb_U32(
    .din0(W_BRAM_7_1_q0),
    .din1(I_BRAM_1_load_reg_1174),
    .dout(tmp_52_7_1_fu_986_p2)
);

HLS2x8_5_mac_mulacud #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 4 ),
    .din1_WIDTH( 5 ),
