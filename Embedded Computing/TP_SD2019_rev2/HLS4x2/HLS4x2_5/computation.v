...
HLS4x2_5_mul_mul_dEe #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS4x2_5_mul_mul_dEe_U21(
    .din0(W_BRAM_0_3_q0),
...
HLS4x2_5_mul_mul_dEe #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS4x2_5_mul_mul_dEe_U23(
    .din0(W_BRAM_1_3_q0),
    .din1(I_BRAM_3_load_reg_935),
    .dout(tmp_52_1_3_fu_749_p2)
);

HLS4x2_5_mac_mulaeOg #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
