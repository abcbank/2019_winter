...
wire   [63:0] tmp_32_cast_fu_679_p1;
...
HLS4x2_3_mul_mul_dEe #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS4x2_3_mul_mul_dEe_U21(
    .din0(W_BRAM_0_3_q0),
...
HLS4x2_3_mul_mul_dEe #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
HLS4x2_3_mul_mul_dEe_U23(
    .din0(W_BRAM_1_3_q0),
    .din1(I_BRAM_3_load_reg_935),
    .dout(tmp_52_1_3_fu_749_p2)
);

HLS4x2_3_mac_mulaeOg #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
...
always @ (posedge ap_clk) begin
    if (((ap_reg_pp0_iter2_exitcond_flatten4_reg_778 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        O_BRAM_0_addr_reg_890 <= tmp_33_cast_fu_708_p1;
        O_BRAM_1_addr_reg_896 <= tmp_33_cast_fu_708_p1;
    end
end
...
assign I_BRAM_0_address0 = tmp_32_cast_fu_679_p1;

assign I_BRAM_1_address0 = tmp_32_cast_fu_679_p1;

assign I_BRAM_2_address0 = tmp_32_cast_fu_679_p1;

assign I_BRAM_3_address0 = tmp_32_cast_fu_679_p1;
...
assign p_shl2_cast_fu_654_p1 = tmp_23_fu_647_p3;
...
assign tf_mid2_fu_605_p3 = ((tmp_22_fu_600_p2[0:0] === 1'b1) ? 4'd0 : tf_reg_324);
...
assign tmp_22_fu_600_p2 = (tmp_14_fu_595_p2 | exitcond_flatten_reg_787);

assign tmp_23_fu_647_p3 = {{tmp_6_mid2_reg_853}, {4'd0}};

assign tmp_32_cast_fu_679_p1 = tmp_17_fu_673_p2;

assign tmp_33_cast_fu_708_p1 = grp_fu_721_p3;
